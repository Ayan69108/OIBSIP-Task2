	...
	public boolean isCorrectGuess() {
		...
		if ( systemInput == userInput ) {
			...
			if ( userInput - systemInput > 10 ) {
				System.out.println("Too High, think more");
			}
			else {
				System.out.println("Little High,very close try one more time");
			}
		}
		else if ( noOfGuesses < 10 && userInput < systemInput ) {
			if ( systemInput - userInput > 10 ) {
				...
				System.out.println("Little low,you are so close keep trying..");
			}
		}
		return false;
	}
